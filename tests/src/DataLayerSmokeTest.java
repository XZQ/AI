...
public class DataLayerSmokeTest {
    public static void main(String[] args) {
        ...
        require(homeResult instanceof DomainResult.Success, "home result type");
        ...
        require(searchResult instanceof DomainResult.Success, "search result type");
        ...
        require(settingResult instanceof DomainResult.Success, "settings result type");
        ...
        require(taskResult instanceof DomainResult.Success, "update result type");

        DomainResult<BatchUpdateReport> batchResult = update.batchUpdate(List.of(new AppId("nav"), new AppId("music")));
        require(batchResult instanceof DomainResult.Success, "batch update result type");
